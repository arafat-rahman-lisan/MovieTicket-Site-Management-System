// File: Services/Service/BookingSeatsService.cs
...
{
    public class BookingSeatsService : EntityBaseRepository<BookingSeat>, IBookingSeatsService
    {
        public BookingSeatsService(AppDbContext context) : base(context) { }
    }
}
